...
<script language="JavaScript" type="text/JavaScript" src="<%=PFConstant.JAVASCRIPT_PATH%>ohand/js/common.js"></script>
<script language="JavaScript" type="text/javascript" src="<%=PFConstant.JAVASCRIPT_PATH%>ohand/js/address.js"></script>
...
function addAddrItem(){
	...
	if(selectedObj[0].iconCls=="icon-user8"){
		...
		<div class="formContent">
			<div id="addrSearch" style="float:left">
				<table border="0" cellpadding="0" cellspacing="0" class="searchtable">
					<tr>
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查询:</td>
						<td><input id="textfield" name="textfield" type="text" style="width:200px" class="input100" value=""></td>
