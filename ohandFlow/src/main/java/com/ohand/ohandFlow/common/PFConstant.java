...
public class PFConstant {
    ...
    public static final String ROOT_CSSPATH = "/styles/";
    
    public static final String JAVASCRIPT_PATH = "/javascripts/";
    
    public static final String CSS_PATH = "/styles/default/";
